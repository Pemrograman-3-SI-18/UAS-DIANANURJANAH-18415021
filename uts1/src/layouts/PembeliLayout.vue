    ...
    >
      <q-scroll-area class="fit">
        <q-list>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/perak">
            <q-item-section avatar>
              <q-icon name="table_chart" />
            </q-item-section>
            <q-item-section>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/bross">
            <q-item-section avatar>
              <q-icon name="table_chart" />
            </q-item-section>
            <q-item-section>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/pembeli/keranjang">
            <q-item-section avatar>
