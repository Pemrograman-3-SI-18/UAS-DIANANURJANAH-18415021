              ...
              <div class="row">
                <div class="col-md-6 col-xs-12">
                  <div class="row q-pt-md q-pb-md bg-white">
                    <div class="col-md-10 offset-2 col-xs-10">
                       <q-img spinner-color="white" placeholder-src="statics/jewelry.jpg" src="statics/jewelry.jpg"></q-img>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-xs-12 q-pt-md">
                  <div class="q-pa-md">
                    <div class="text-blue-grey-14 text-h4"> D&A JEWELRY SILAHKAN LOGIN</div>
